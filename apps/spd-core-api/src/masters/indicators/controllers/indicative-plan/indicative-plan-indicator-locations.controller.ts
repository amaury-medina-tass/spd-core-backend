...
export class IndicativePlanIndicatorLocationsController {
    ...
    /**
     * Buscar indicadores indicativos por código de comuna
    ...
    findByCommuneCode(
        ...
        return this.indicatorLocationsService.findIndicativeIndicatorsByCommuneCode(
            communeCode,
    ...
    findVariablesByLocation(
        ...
        return this.indicatorLocationsService.findVariablesByIndicativeIndicatorLocation(
            indicatorId,
            Number.parseInt(page, 10) || 1,
            Number.parseInt(limit, 10) || 10,
            search
