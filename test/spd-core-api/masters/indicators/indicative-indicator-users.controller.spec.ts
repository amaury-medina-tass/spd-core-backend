import { IndicativeIndicatorUsersController } from '../../../../apps/spd-core-api/src/masters/indicators/controllers/indicative-plan/indicative-indicator-users.controller';

describe('IndicativeIndicatorUsersController', () => {
    let controller: IndicativeIndicatorUsersController;
    let mockService: any;
    ...
    beforeEach(() => {
        ...
        controller = new IndicativeIndicatorUsersController(mockService);
    });
