...
import { ActionPlanIndicatorGoalsService } from '../../../../apps/spd-core-api/src/masters/indicators/services/action-plan/action-plan-indicator-goals.service';
...
describe('ActionPlanIndicatorGoalsService', () => {
    let service: ActionPlanIndicatorGoalsService;
    ...
    beforeEach(() => {
        ...
        service = new ActionPlanIndicatorGoalsService(mockGoalRepo, mockIndicatorRepo, mockAuditLog);
    });
